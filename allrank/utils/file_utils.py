...
class PathsContainer:
    ...
    job_dir = attrib(type=str)
    run_id = attrib(type=str)
    ...
    def from_args(cls, output, run_id, config_path, package_name="allrank"):
        ...
        return cls(local_base_output_path, base_output_path, output_dir, tensorboard_output_path, config_path, output, run_id)
