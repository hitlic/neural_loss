...
class DataConfig:
    ...
    ds_type=attrib(type=str, default='')   # 新加的属性
...
class Config:
    ...
    test_metrics = attrib(type=Dict[str, List[int]], default=None)
    ...
    alter_models = attrib(type=Dict[str, Dict[str, float]], default=None)
    paths = None
    ...
    def from_dict(cls, config):
        ...
        config["test_metrics"] = cls._parse_metrics(config["test_metrics"])
